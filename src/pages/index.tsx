        ...
        <section className="text-primary flex items-center h-screen justify-center px-5">
          <div className="mx-auto max-w-[43rem]">
            <div className="text-center">
              ...
              <h1 className="mt-3 text-[3.5em] font-black tracking-tight">Defining the Journeys Next Chapter</h1>
              ...
              <div className="flex md:order-2 flex-wrap justify-center py-5 gap-2 fill-dark">
                <a className="p-2 font-semibold inline-flex items-center space-x-2 rounded" href="">
...
export const Head: HeadFC = () => <>
  ...
  <meta name="description" content="Defining the Next Chapter and Sharing the Journey" />
  <meta name="image" content='/gatsby-icon.png' />
  ...
  <meta name="twitter:description" content='Defining the Next Chapter and Sharing the Journey' />
  <meta name="twitter:image" content='/gatsby-icon.png' />
