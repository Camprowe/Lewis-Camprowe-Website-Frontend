          ...
          <div className="mx-auto max-w-[43rem]">
            <div className="text-center">
              ...
              <div className="flex md:order-2 flex-wrap justify-center py-5 gap-2 fill-dark">
                ...
                <a className="p-2 inline-flex items-center space-x-2" href="/instagram">
                  <svg className="w-5 h-5 hover:fill-primary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a className="p-2 inline-flex items-center space-x-2" href="/youtube">
                  <svg className="w-5 h-5 hover:fill-primary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a className="p-2 inline-flex items-center space-x-2" href="/linkedin">
                  <svg className="w-5 h-5 hover:fill-primary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
